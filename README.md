...
```
git clone git@github.com:linhbkhn95/sails-clean-architecture.git
cd sails-clean-architecture
npm install
npm run test
npm run start or sails lift
```
...
Server, routes and plugins can be considered as "plumbery-code" that exposes the API to the external world, via an instance of Sails.js server. 
